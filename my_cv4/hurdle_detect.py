...
class HurdleDetectorNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("a_high", 130)  # 핑크
    ...
    def cam2_image_callback(self, color_msg: Image):
            ...
            if self.frames_left <= 0:
                ...
                if result:
                    ...
                    if avg_cy >= self.limit_half_step:
                        avg_angle = 0
                        res = 14 # 스텝인플레이스고고  << forward_half 임시
                        # self.jump = True
                        self.is_hurdle = False
                        self.cy_hurdle_cal = 0
        ...
        cv2.line(frame, (self.roi_x_start, self.limit_two_step), (self.roi_x_end, self.limit_two_step), (123, 124, 55), 2)

...
class ImgSubscriber(Node):
    ...
    def color_image_callback(self, msg):
            ...
            print("cuda inRange ref:", cv2.cuda.inRange)
            print("gpu_hsv_eq type:", type(gpu_hsv_eq))
            print("lower:", hsv_lower_white, type(hsv_lower_white))
            print("upper:", hsv_upper_white, type(hsv_upper_white))
